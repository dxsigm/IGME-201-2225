...
namespace BTree
{
    ...
    public class BTree
    {
        ...
        //////////////////////////////////////////////////////////
        ///
        public static void PreOrderTraversal(BTree node)
        {
            if (node != null)
            {
                if (node.isData)
        ...
        public static void PostOrderTraversal(BTree node)
        {
            if (node != null)
            {
                TraverseDescending(node.ltChild);
        ...
        public static void BreadthFirstTopDownTraversal(BTree root)
        {
            ...
            while (queue.Count != 0)
            {
                ...
                {
                    queue.Enqueue(node.ltChild);
                }

                if (node.gteChild != null)
                {
                    queue.Enqueue(node.gteChild);
                }
            }
        }
    }
